...
<body>
	...
	<form action="/hello2/answer.jsp" method = "post" >
	<p>다음 문제의 답을 입력하세요.</p>
		<image src = "/hello2/찢어진 달력.png" /><br />
		...
		동생과 형은 0.0mm의 오차도 없이 학교의 정문에서 마주쳤습니다.<br />
